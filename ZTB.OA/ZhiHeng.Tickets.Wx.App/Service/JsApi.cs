...
namespace ZhiHeng.Tickets.Wx.App.Service
{
    public class JsApi
    {
        ...
        /// <returns></returns>
        public static JsApiTicket GetHsJsApiTicket()
        {
            var url = string.Format("https://api.weixin.qq.com/cgi-bin/ticket/getticket?access_token={0}&type=jsapi", WXService.AccessToken);
